...
export const es = {
    ...
    stats: {
        ...
        weeklySubMonths:  'Últimos 12 meses',
        weeklyBtnWeeks:   'Semanas',
        weeklyBtnDays:    'Días',
        weeklyBtnMonths:  'Meses',
        weeklyDataLabelMonths: 'Minutos por mes',
        ...
        compareDeltaHeader:   'Δ Dif.',
        compareWeeklyTitle: 'Minutos practicados',
        compareWeeklySub:   'Prashant (naranja) · Meera (azul) · últimas 16 semanas',
        compareMonthlyTitle: 'Minutos practicados',
        compareMonthlySub:   'Prashant (naranja) · Meera (azul) · últimos 12 meses',
        compareBtnWeeks:    'Semanas',
        compareBtnMonths:   'Meses',
        compareDonutP:    'Distribución · Prashant',
        compareDonutM:    'Distribución · Meera',
        compareMedalsTitle: 'Medallas',
        // Cumulative chart
        cumulativeTitle:    'Minutos acumulados',
        cumulativeSub:      'Total histórico · Prashant (naranja) vs Meera (azul) · la brecha muestra quién va adelante',
        cumulativeYAxis:    'Total acumulado',
        cumulativeGapAxis:  'Diferencia',
        cumulativeGapLabel: 'Brecha',
        cumulativeTied:     'Empate',
        cumulativeLeads:    (who: string, fmt: string) => `${who} lleva +${fmt} de ventaja`,
        ...
        medalMaestro:     { name: 'Maestra y alumno',   desc: '10 sesiones conjuntas con tu compañero' },
        medalDuo20:       { name: 'Dúo constante',      desc: '20 sesiones conjuntas con tu compañero' },
        medalDuo50:       { name: 'Dúo devoto',         desc: '50 sesiones conjuntas con tu compañero' },
        medalDuo100:      { name: 'Dúo centenario',     desc: '100 sesiones conjuntas con tu compañero' },
        medalDuoLegend:   { name: 'Dúo legendario',     desc: '120 min acumulados en sesiones conjuntas' },
        medalDuo5h:       { name: '5 horas conjuntas',  desc: '300 min acumulados en sesiones conjuntas' },
        medalDuo10h:      { name: '10 horas conjuntas', desc: '600 min acumulados en sesiones conjuntas' },
        medalDuo25h:      { name: '25 horas conjuntas', desc: '1500 min acumulados en sesiones conjuntas' },
        medalDuo50h:      { name: '50 horas conjuntas', desc: '3000 min acumulados en sesiones conjuntas' },
